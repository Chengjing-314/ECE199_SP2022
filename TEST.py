...
cupUID = p.loadURDF("data/dinnerware/cup/cup_small.urdf", basePosition = [0.85, 0.1, 0.01])
duckUID = p.loadURDF("data/duck/duck_vhacd.urdf", basePosition = [0.55, -0.1, 0.01])
